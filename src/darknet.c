...
{
	const string path = "/home/will/Desktop/DATA/Woodpile\ road/";
...
int main(int argc, char **argv)
{
    ...
    cvCreateVideoWriter("demo.avi", CV_FOURCC('I', 'Y', 'U', 'V'), 10, cvSize(480, 320), 1);
    ...
    //nms to change the threshold
    float nms=.5;

    for(int i=1; i<530; i++) {
		
		//copy the filename
        strncpy(input, generateFileName(i).c_str(), 512);

	//string temp = "data/animals/" + to_string(i) + ".JPG";

	//strncpy(input, temp.c_str(), 512);
